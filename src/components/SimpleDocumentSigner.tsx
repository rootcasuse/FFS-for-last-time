...
import { FileText, Upload, Download, Shield, CheckCircle, XCircle, Key, Info, AlertCircle, Copy, Save } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      <div className="text-center">
        ...
        <h1 className="text-3xl font-bold text-white mb-2">Simple Document Signer</h1>
        ...
        <div className="space-y-4">
          <div className="bg-gray-700 rounded-lg p-4">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm text-gray-400">Session Signing Key (save this!)</span>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full p-3 bg-gray-700 rounded-lg border border-gray-600 text-white placeholder-gray-400 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 font-mono text-sm"
            />
